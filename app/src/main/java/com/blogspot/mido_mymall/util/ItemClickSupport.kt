...
class ItemClickSupport private constructor(private val recyclerView: RecyclerView) {
    ...
    private val onLongClickListener = View.OnLongClickListener { v ->
        ...
        val holder = this.recyclerView.getChildViewHolder(v)
        return@OnLongClickListener listener.invoke(this.recyclerView, holder.layoutPosition, v)
    }
...
// Extension function
inline fun RecyclerView.addItemClickSupport(configuration: ItemClickSupport.() -> Unit = {}) = ItemClickSupport.addTo(
    this
).apply(configuration)
