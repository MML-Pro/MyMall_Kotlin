...
//        super.onStart(owner)
//        ConsentDebugSettings.Builder(this).addTestDeviceHashedId("B3EEABB8EE11C2BE770B684D95219ECB").build()
//        currentActivity?.let {
...
//    }
    ...
    inner class AppOpenAdManager {
        ...
        fun loadAd(context: Context) {
            ...
            AppOpenAd.load(context, getString(R.string.app_open_ad), request, object : AppOpenAdLoadCallback() {
                    /**
...
//        private const val AD_UNIT_ID = "ca-app-pub-3940256099942544/9257395921"
        private const val LOG_TAG = "BaseApplication"
