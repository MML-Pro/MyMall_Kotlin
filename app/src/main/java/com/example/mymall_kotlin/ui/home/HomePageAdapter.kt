...
import com.example.mymall_kotlin.databinding.GridProductLayoutBinding
import com.example.mymall_kotlin.databinding.HorizontalScrollLayoutBinding
import com.example.mymall_kotlin.databinding.SlidingAdLayoutBinding
import com.example.mymall_kotlin.databinding.StripAdLayoutBinding
...
//                hsProductImage.setImageResource(horizontalProductScrollModelList.get(i).getProductImage());
                ...
                hsProductDescription.text = horizontalProductScrollModelList[i].productDescription
                hsProductPrice.text = "Rs.${horizontalProductScrollModelList[i].productPrice}/-"
                val productID: String = horizontalProductScrollModelList[i].productID.toString()

                binding.gridLayout.getChildAt(i).setOnClickListener { view ->
                    findNavController(binding.root)
                        .navigate(
